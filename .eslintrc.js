...
const memberNames = [
	...
	'^(?:broadcast|grant|response|message|user|emote|subscription)_type$',
	'^force_verify$',
	'^expires_in$',
	'^badge_sets$',
	...
	'(?:^|_)(?:start|end)_time$',
	'^(?:(?:offline|profile|background)_image|edit|embed|thumbnail|box_art|click|viewer|icon|eula_tos|privacy_policy|reconnect)_url$',
	'^click_action$',
	'^(image_)?url_\\dx$',
	'^emoticon_sets?$',
	...
	'^product_(type|data)$',
	'^community_ids$',
	'^(position|keepalive_timeout)_seconds$',
	...
	'^chat_message$',
	'^badge_tier$',
	'^(?:previous|new|extension|format|subscription)_version$',
	'^(total_)?bits_used$',
	'^badge_entitlement$',
	'^moderation_action$',
	'^created_by$',
