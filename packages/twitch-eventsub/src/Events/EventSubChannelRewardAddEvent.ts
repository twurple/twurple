...
/**
 * An EventSub event representing a broadcaster adding a Channel Points reward to their channel.
 */
export class EventSubChannelRewardAddEvent {
	/** @private */
	@Enumerable(false) protected readonly _client: ApiClient;

	/** @private */
	constructor(private readonly _data: EventSubChannelRewardAddEventData, client: ApiClient) {
		this._client = client;
	}
