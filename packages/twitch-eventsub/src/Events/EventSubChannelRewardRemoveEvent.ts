...
export interface EventSubChannelRewardRemoveEventData {
	/** @private */
	id: string;
...
/**
 * An EventSub event representing a broaster removing a Channel Points reward from their channel.
 */
export class EventSubChannelRewardRemoveEvent {
	/** @private */
	@Enumerable(false) protected readonly _client: ApiClient;

	/** @private */
	constructor(private readonly _data: EventSubChannelRewardRemoveEventData, client: ApiClient) {
		this._client = client;
	}
