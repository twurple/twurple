...
import { type EventSubChannelSharedChatUnbanModerationEventData } from './EventSubChannelModerationEvent.external.js';
...
export class EventSubChannelSharedChatUnbanModerationEvent extends EventSubChannelBaseModerationEvent {
	...
	async getUser(): Promise<HelixUser | null> {
		if (!this._client) {
			throw new Error('EventSubChannelSharedChatUnbanModerationEvent#getUser is not supported in this context');
		}
