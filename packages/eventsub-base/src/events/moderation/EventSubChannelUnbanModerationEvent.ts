...
import { type EventSubChannelUnbanModerationEventData } from './EventSubChannelModerationEvent.external.js';
...
export class EventSubChannelUnbanModerationEvent extends EventSubChannelBaseModerationEvent {
	...
	async getUser(): Promise<HelixUser | null> {
		if (!this._client) {
			throw new Error('EventSubChannelUnbanModerationEvent#getUser is not supported in this context');
		}
