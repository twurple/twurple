...
import { type EventSubChannelDeleteModerationEventData } from './EventSubChannelModerationEvent.external.js';
...
export class EventSubChannelDeleteModerationEvent extends EventSubChannelBaseModerationEvent {
	...
	async getUser(): Promise<HelixUser | null> {
		if (!this._client) {
			throw new Error('EventSubChannelDeleteModerationEvent#getUser is not supported in this context');
		}
