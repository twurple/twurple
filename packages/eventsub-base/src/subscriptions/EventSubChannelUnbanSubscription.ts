...
export class EventSubChannelUnbanSubscription extends EventSubSubscription<EventSubChannelUnbanEvent> {
	...
	protected transformData(data: EventSubChannelUnbanEventData): EventSubChannelUnbanEvent {
		return this._client._config.managed
			? new EventSubChannelUnbanEvent(data, this._client._config.apiClient)
			: new EventSubChannelUnbanEvent(data);
	}

	protected async _subscribe(): Promise<HelixEventSubSubscription | undefined> {
		return this._client._config.managed
			? await this._client._config.apiClient.eventSub.subscribeToChannelUnbanEvents(
					this._userId,
